...
import { MantleSmallIcon, MinterestSmallBlackIcon } from 'assets/svg';
import {
...
import { useAddressesQuery } from 'features/network/redux/api';
import {
  MntDetails,
...
import { selectUserAddress } from '../wallet';
